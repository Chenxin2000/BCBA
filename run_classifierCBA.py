...
def evaluate(args, dataset, print_confusion_matrix=False):
    ...
    unique_labels = set(tgt.numpy())

    # Get label names from the tokenizer or any other source in your dataset.
    ...
    if print_confusion_matrix:
        ...
        for i in range(confusion.size()[0]):
            ...
            for j in range(confusion.size()[1]):
                print(confusion[i, j].item(), end=" ")
            print()  """
        print(confusion)
        cf_array = confusion.numpy()
        with open("I:/ET-BERT-main/data2/lxj/pre-train/results/confusion_matrix0402",'w') as f:
